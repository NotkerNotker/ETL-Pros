...
COPY Player_Draft_Information FROM 'C:\Users\lukee\Desktop\ETL-Pros\DraftDataIDClean.csv' DELIMITER ',' CSV HEADER;
COPY "Players" FROM 'C:\Users\lukee\Desktop\ETL-Pros\Player_lookup.csv' DELIMITER ',' CSV HEADER;
